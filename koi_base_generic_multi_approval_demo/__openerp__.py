...
##############################################################################
{
    ...
    """,
    'depends': [
        'koi_base_generic_multi_approval'
    ],
    'data': [
        'view/view_ApprovalExample1.xml',
        'window_action/waction_ApprovalExample1.xml',
        'view/view_ApprovalExample2.xml',
        'window_action/waction_ApprovalExample2.xml',
